...
class tourguideSettingsScreen extends StatefulWidget {
  tourguideSettingsScreen({Key key}) : super(key: key);

  @override
  tourguideSettingsScreenState createState() => tourguideSettingsScreenState();
}

class tourguideSettingsScreenState extends State<tourguideSettingsScreen> {
                      ...
                      showDialog(
                        ...
                        builder: (BuildContext context){
                          return new AlertDialog(
                              ...
                              content: Text('Confirm change to Tourist Guide Mode?'),
                              actions: <Widget>[
                                FlatButton(
                                    child:Text('OK'),
                                    onPressed:(){
